...
from shared import credits, size, GameName, square_size, player_color, fps, game_border1, game_border2, speed, info_color, dialog_color, background_color
...
while not done:
    # clock.tick() limits the while loop to a max of 10 times per second.
        ...
        if facing == "Left":
            ...
            image_display(screen, "Textures/npcup.png", [playerx,playery])
        elif facing == "Down":
            image_display(screen, "Textures/npcdown.png", [playerx,playery])
        if playerx > infox:
            ...
            if playery > infoy:
                image_display(screen, "Textures/scientist_down.png", [infox,infoy])
            elif playery < infoy:
                image_display(screen, "Textures/scientist_up.png", [infox,infoy])
